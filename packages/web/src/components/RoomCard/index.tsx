...
const RoomCard = () => {
    return (
        <Card style={{padding: '0.3rem'}}>
            ...
            />
            <div>
                <div style={{fontSize: '0.4rem', fontWeight: '700', paddingBottom: '0.2rem'}}>2室1厅 田家园新村（四区）</div>
                <div style={{paddingBottom: '0.2rem'}}>72平/南北/高楼层/敞亮</div>
                <div style={{fontWeight: '700', paddingBottom: '0.2rem'}}>南北通透 绿化率高</div>
                <div><span style={{fontSize: '0.4rem', paddingRight: '0.2rem', color: 'red'}}>150万</span> 20,833元/平</div>
            </div>
        </Card>
    )
}
